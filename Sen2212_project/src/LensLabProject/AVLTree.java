package LensLabProject;
	...
	{  
	    ...
	    public void insertElement(Lens element)  
	    {  
	    ...
	    private Node insertElement(Lens element, Node node)  
	    {  
	        ...
	        {  
	            ...
	            if( getHeight( node.leftChild ) - getHeight( node.rightChild ) == 2 )  
	                if( element.getID() < node.leftChild.element.getID() )  
	        ...
	        {  
	            ...
	            if( getHeight( node.rightChild ) - getHeight( node.leftChild ) == 2 )  
	                if( element.getID() > node.rightChild.element.getID())  
	    ...
	    {  
	        ...
	        {  
	            int headElement = head.element.getID();  
	    ...
	    {  
	        ...
	        {  
	            ...
	            System.out.print(head.element.getID()+" " + head.element.getLensNo() +" " + head.element.getColor() +" ");  
	            System.out.println();
	    ...
	    {  
	        ...
	        {  
	            ...
	            System.out.print("Lens ID: "+head.element.getID()+" Lens No: " + head.element.getLensNo() +" Lens Color: " + head.element.getColor() +" ");  
	            System.out.println();
	        }  
	    }       
	}  
