...
//        	private boolean isDelivered;
                ...
                case 1 :   
                    System.out.println("Please enter the ID of Lens to insert in AVL Tree");
                    int id = sc.nextInt();
                    System.out.println("Please enter Lens No of Lens to insert in AVL Tree");
                    double no = sc.nextDouble();
                    System.out.println("Please enter the color of Lens to insert in AVL Tree");
                    String color= sc.next();

                    
                    Lens newLens= new Lens(id,no,color,false);
                    
                    obj.insertElement( newLens );                       
                    break;                            
                case 2 :   
